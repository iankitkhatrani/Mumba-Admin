...
import styles from './RegisterReferralBonus.module.css'; // Import the CSS module


const RegisterReferralBonus = (props) => {
    const [selectedClub, setSelectedClub] = useState('');
    const [searchPhoneNumber, setSearchPhoneNumber] = useState('');
    const [entriesPerPage, setEntriesPerPage] = useState(5);
    const [currentPage, setCurrentPage] = useState(1);

    let gameHistoryData  = props.registerReferralBonusData
...
export default RegisterReferralBonus;
